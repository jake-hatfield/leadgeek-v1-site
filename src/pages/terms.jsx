  ...
  return (
    <Layout>
      ...
      <section className="my-8 md:my-12 lg:my-16 max-w-2xl container text-gray-900">
        ...
        <h2 className="mt-6 text-xl font-bold">Intellectual property rights</h2>
        <p className="mt-4 text-gray-700">
        ...
        <h2 className="mt-6 text-xl font-bold">User representations</h2>
        <p className="mt-4 text-gray-700">
        ...
        <h2 id="subscription-policy" className="mt-6 text-xl font-bold">
          Fees and payment
        </h2>
        <p className="mt-4 text-gray-700">
        ...
        <ul className="mt-4">
          <li className="mt-2 text-gray-700">- Visa</li>
          <li className="mt-2 text-gray-700">- Mastercard</li>
          <li className="mt-2 text-gray-700">- Discover</li>
          <li className="mt-2 text-gray-700">- American Express</li>
        </ul>
        <p className="mt-4 text-gray-700">
          ...
          needed. We process payments securely with Stripe. Sales tax will be
        ...
        <h2 id="cancellation-policy" className="mt-6 text-xl font-bold">
        ...
        <ol className="mt-4">
          ...
          <li className="mt-2 text-gray-700">
            7. Decipher, decompile, disassemble, or reverse engineer any of the
            software comprising or in any way making up a part of the site.
          </li>
          <li className="mt-2 text-gray-700">
            8. Attempt to bypass any measures of the site designed to prevent or
            restrict access to the site, or any portion of the site.
          </li>
          <li className="mt-2 text-gray-700">
            9. Copy or adapt the site’s software, including but not limited to
            HTML, JavaScript, CSS, or other code.
          </li>
          <li className="mt-2 text-gray-700">
          ...
          <li className="mt-2 text-gray-700">
            11. Use the Site in a manner inconsistent with any applicable laws
            or regulations.
          </li>
        </ol>
        <h2 className="mt-6 text-xl font-bold">Submissions</h2>
        <p className="mt-4 text-gray-700">
        ...
        <p className="mt-4 text-gray-700">
          ...
          does not imply approval or endorsement thereof by us.
        </p>
        <p className="mt-4 text-gray-700">
        ...
        <h2 className="mt-6 text-xl font-bold">Site management</h2>
        <p className="mt-4 text-gray-700">
        ...
        <h2 className="mt-6 text-xl font-bold">Term and termination</h2>
        <p className="mt-4 text-gray-700">
        ...
        <h2 className="mt-6 text-xl font-bold">Corrections</h2>
        <p className="mt-4 text-gray-700">
        ...
        <h2 className="mt-6 text-xl font-bold">Earnings disclaimer</h2>
        <p className="mt-4 text-gray-700">
          We are unable to offer any guarantees as to any income during the term
          of this agreement. You accept full responsibility for your financial
          performance during this agreement. You understand and accept that your
          income depends on your own individual capacity, expertise, experience,
          and efforts. The company is unable to assume any responsibility for
          your success or offer any guarantees of any nature whatsoever.
        </p>
        <p className="mt-4 text-gray-700">
          You understand and accept that we do not have any control or influence
          on any customer’s decision to acquire your product on any third-party
          marketplace. We will not be held liable for your success or failure to
          achieve any specific financial or career goals during this agreement.
        </p>
