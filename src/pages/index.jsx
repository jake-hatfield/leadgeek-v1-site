      ...
      <aside className="lg:mx-0 mt-8 lg:mt-0 lg:max-w-xl lg:w-2/3 xl:w-3/5 text-gray-700">
        ...
        <div className="mt-8 lg:mt-12 md:flex md:justify-between text-gray-700">
          ...
          <div className="mt-8 md:mt-0 lg:w-1/2">
            ...
            <p className="mt-2">
              Reach out to us for dedicated support, Amazon selling assistance,
              and other perks exclusive to LeadGeek members.
            </p>
            <ArrowLink
        ...
        <article className="mt-8 lg:mt-0 md:max-w-xl lg:w-3/5">
          ...
          <header className="mt-6">
            ...
            <p className="mt-2">
              ...
              products must adhere to several high criteria before you ever even
              see them, which means you only receive the cream-of-the-crop
          ...
          <aside className="mt-4 text-gray-700">
            ...
            <div className="mt-4 flex">
              ...
              <div className="ml-8 md:w-1/4">
                <span className="font-bold text-4xl text-purple-600">40%</span>
                <span className="block uppercase text-sm">Minimum ROI</span>
              </div>
              <div className="ml-8 md:w-1/4">
                <span className="font-bold text-4xl text-purple-600">10+</span>
